...
export function AboutSection() {
  return (
    <section
      id="about"
      className="py-12 md:py-20 px-4 bg-gradient-to-r from-pink-50 to-purple-50"
    >
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-2 lg:order-1">
            <Badge className="mb-4 md:mb-6 bg-pink-100 text-pink-700">
              About Dashboard Buzz
            </Badge>
            ...
            <p className="text-base md:text-lg text-gray-600 mb-4 md:mb-6">
              Dashboard Buzz is a cutting-edge platform that facilitates brand
              promotion through strategic nano and micro influencer marketing.
              We empower content creators by providing them with the tools and
